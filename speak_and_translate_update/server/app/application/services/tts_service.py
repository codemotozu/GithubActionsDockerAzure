...
#         """Generate word-by-word SSML for MULTIPLE selected styles."""
...
#             <prosody rate="1.0">
#                 <lang xml:lang="{voice_config['language']}">{translation_text}</lang>
#                 <break time="600ms"/>
#             </prosody>
#         </voice>"""
...
#                         ssml += f"""
#                 <lang xml:lang="{voice_config['language']}">{source}</lang>
#                 <break time="200ms"/>
...
#                 # Add section break between styles
#                 ssml += """
#         <break time="800ms"/>"""
...
#         """Generate simple SSML for multiple styles (just reads translations)."""
#         ssml = """<speak version="1.0" xmlns="http://www.w3.org/2001/10/synthesis" xml:lang="en-US">"""
...
#         <voice name="{voice}">
#             <prosody rate="1.0">
#                 <lang xml:lang="{lang_code}">{translation_text}</lang>
#                 <break time="800ms"/>
#             </prosody>
#         </voice>"""
...
#         """Generate SSML for word-by-word audio (single style - backward compatibility)"""
...
#         """Generate simple SSML that just reads translations (single style - backward compatibility)."""
#         # Check if we have multiple styles
#         style_count = len(translations_data.get('style_data', []))
